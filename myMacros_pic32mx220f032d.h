...
#ifndef MY_MACROS_PIC32MX220F032D_H    /* Guard against multiple inclusion */
#define MY_MACROS_PIC32MX220F032D_H 
...
#define TIMER1_PRESCALE_1_64() T1CONbits.TCKPS = 2 // Timer Input Clock Prescale Select bits
...
#define ADC1_IF_CLEAR() IFS0CLR = _IFS0_AD1IF_MASK
#define ADC1_AUTO_CONVERSION() AD1CON1SET = _AD1CON1_SSRC_MASK
#define ADC1_FORM_INT16() AD1CON1CLR = _AD1CON1_FORM_MASK
#define ADC1_FORM_INT32() AD1CON1SET = _AD1CON1_FORM2_MASK
#define ADC1_VREF_TO_VDD() AD1CON2CLR = _AD1CON2_VCFG_MASK  // AD1CON2bits.VCFG //AD1CON2<15:13>     
...
#define ADC1_AUTOSTART() AD1CON1SET = _AD1CON1_ASAM_MASK
#define ADC1_START_SAMPLING() AD1CON1bits.SAMP = 1
#define ADC1_CLR_DONE() AD1CON1CLR = _AD1CON1_DONE_MASK

#define ADC1_CONVERT()     AD1CON1CLR = _AD1CON1_SAMP_MASK

#endif /* MY_MACROS_PIC32MX220F032D_H */
